...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		// #special move En Passant -> pawn moved 2 layers? , yep = vulnerable
	...
	private Piece makeMove(Position source, Position target) {
		...
		if (p instanceof King && target.getColumn() == source.getColumn() + 2) { // right
		...
		if (p instanceof King && target.getColumn() == source.getColumn() - 2) { // left
